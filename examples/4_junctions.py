...
def main():
    ...
    junction3 = stop().with_stop_on_road(Orientation.SOUTH)
    ...
    s.add_road(junction1.connect(Orientation.EAST).to(junction2).with_length(8).with_n_ways(1))
    ...
    s.add_road(junction2.connect(Orientation.SOUTH).to(junction3).with_length(8).with_n_ways(1))
    ...
    s.add_road(junction3.connect(Orientation.WEST).to(junction4).with_length(8).with_n_ways(1))
    ...
    s.add_road(junction4.connect(Orientation.NORTH).to(junction1).with_length(8).with_n_ways(1))
